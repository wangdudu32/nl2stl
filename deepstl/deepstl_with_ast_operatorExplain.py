...
def build_system_prompt(schema_text: str, operator_explanations: str) -> str:
...
- Use the STL operator explanations only as semantic guidance for choosing the correct schema operator.
- If the operator explanations conflict with the JSON Schema, the JSON Schema takes precedence.
...
def main() -> None:
    ...
    system_prompt = build_system_prompt(schema_text, operator_explanations)
