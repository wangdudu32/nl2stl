...
EXPERIMENT_TAG = "two_way_iteration_with_ast"
...
OUTPUT_FILE = (
    PROJECT_ROOT
    / "result/two_way_iteration_with_ast_deepseek_v4_pro_result.txt"
)
FAIL_TIMES_FILE = (
    PROJECT_ROOT / "tmp/two_way_iteration_with_ast_fail_times.txt"
)
TRACE_FILE = (
    PROJECT_ROOT
    / "result/ast_intermediate/two_way_iteration_with_ast.jsonl"
)
...
def build_llm1_system_prompt(schema_text: str) -> str:
...
def main() -> None:
    ...
    llm1_system_prompt = build_llm1_system_prompt(schema_text)
