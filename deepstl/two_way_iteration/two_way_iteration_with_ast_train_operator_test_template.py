...
EXPERIMENT_TAG = "two_way_iteration_with_ast_train_operator_test_template"
...
OPERATOR_KNOWLEDGE_FILE = PROJECT_ROOT / "knowledge_base/train_operator_knowledge.txt"
TEMPLATE_OPERATOR_KNOWLEDGE_FILE = PROJECT_ROOT / "knowledge_base/template_knowledge.txt"
OUTPUT_FILE = (
    PROJECT_ROOT
    / "result/two_way_iteration_with_ast_train_operator_test_template_deepseek_v4_pro_result.txt"
)
FAIL_TIMES_FILE = (
    PROJECT_ROOT / "tmp/two_way_iteration_with_ast_train_operator_test_template_fail_times.txt"
)
TRACE_FILE = (
    PROJECT_ROOT
    / "result/ast_intermediate/two_way_iteration_with_ast_train_operator_test_template.jsonl"
)
...
def build_run_signature(llm1_system_prompt: str) -> str:
    signature_parts = [
        "two-way-iteration-with-ast-train-operator-test-template-v1",
        EXPERIMENT_TAG,
        LLM1_MODEL,
        LLM2_MODEL,
        LLM3_MODEL,
